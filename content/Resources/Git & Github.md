...
> [!tip]
> The following resource is a **must check**: [Github Tutorial](https://kbroman.org/github_tutorial/)
...
- [GitHub: Sync Notifications with Discord Chat! - YouTube](https://www.youtube.com/watch?v=-KDQqWNK3Tw)
- [json - Discord webhook post to channel thread - Stack Overflow](https://stackoverflow.com/a/72089643)
