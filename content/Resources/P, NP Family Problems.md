...
[Open question: Does P = NP? | No, P ≠ NP](../attachments/p_np_np-hard_np-complete.pdf)
...
[Every problem in NP is reducible to HC in polynomial time. Ex: TSP is reducible to HC. Example: lcm(m, n) = m \* n / gcd(m, n)](../attachments/p_np_np-hard_np-complete.pdf)
...
[Deep Looks into P, NP, NP-Hard and NP-Complete Problems.pdf](../attachments/p_np_np-hard_np-complete.pdf)
